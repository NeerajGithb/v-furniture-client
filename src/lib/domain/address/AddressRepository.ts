...
export class AddressRepository implements IAddressRepository {
  ...
  async findById(addressId: string): Promise<AddressType> {
    try {
      ...
      throw new RepositoryError("Failed to find address by ID", error as Error);
    }
  }
  ...
  async findByIdAndUserId(
    ...
    try {
      ...
      throw new RepositoryError(
        "Failed to find address by ID and user ID",
        error as Error,
      );
    }
  }
  ...
  async findByUserId(
    ...
    try {
      ...
      throw new RepositoryError(
        "Failed to find addresses by user ID",
        error as Error,
      );
    }
  }
  ...
  async findDuplicate(
    ...
    try {
      ...
      throw new RepositoryError(
        "Failed to check for duplicate address",
        error as Error,
      );
    }
  }
  ...
  async create(
    ...
    try {
      ...
      throw new RepositoryError("Failed to create address", error as Error);
    }
  }
  ...
  async update(
    ...
    try {
      ...
      throw new RepositoryError("Failed to update address", error as Error);
    }
  }
  ...
  async delete(addressId: string, userId: string): Promise<boolean> {
    try {
      ...
      throw new RepositoryError("Failed to delete address", error as Error);
    }
  }
  ...
  async countByUserId(userId: string): Promise<number> {
    try {
      ...
      throw new RepositoryError("Failed to count addresses", error as Error);
    }
  }
