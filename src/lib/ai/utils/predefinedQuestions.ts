...
const STATIC_PATTERNS: QuestionPattern[] = [
  ...
  // ── "Show sofas under ₹50,000" ────────────────────────────────
  {
    patterns: [
      ...
      "sofa below 50000",
      "sofas below 50000",
      "cheap sofas under 50000",
      "affordable sofas under 50000",
      "find sofas under 50000",
      "show me sofas under 50000",
      "show me sofas under ₹50,000",
    ],
    understanding: {
      coarse_intent: "BROWSING",
      whatUserWants: "find sofas under ₹50,000",
      info_type: null,
      info_entity: null,
      detail_level: null,
      language: "en",
  ...
  // ── "I need a king-size bed" ──────────────────────────────────
  {
    patterns: [
      ...
      "king bed",
      "king sized bed",
      "show me king sized beds",
    ],
    understanding: {
      coarse_intent: "BROWSING",
      whatUserWants: "browse king size beds",
      info_type: null,
      info_entity: null,
      detail_level: null,
      language: "en",
  ...
  // ── "Browse all categories" ───────────────────────────────────
  {
    ...
    understanding: {
      coarse_intent: "ACTION",
      whatUserWants: "view all furniture categories",
      info_type: null,
      info_entity: null,
      detail_level: null,
      language: "en",
      action_type: "viewCategories",
      entities: {
        category: null,
        subcategory: null,
        brand: null,
  ...
  // ── "How many products are available?" ────────────────────────
  {
    ...
    understanding: {
      coarse_intent: "INFORMATION",
      whatUserWants: "know total number of products",
      info_type: "COUNT",
      info_entity: "PRODUCT",
      detail_level: null,
      language: "en",
      action_type: "provideCount",
      entities: {
        category: null,
        subcategory: null,
        brand: null,
  ...
  // ── "Furniture for my bedroom" ────────────────────────────────
  {
    ...
    understanding: {
      coarse_intent: "BROWSING",
      whatUserWants: "find bedroom furniture",
      info_type: null,
      info_entity: null,
      detail_level: null,
      language: "en",
