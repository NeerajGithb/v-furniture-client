...
const Page = () => {
  ...
  const { currentInspiration, setCurrentInspiration, clearCurrentInspiration } = useHomeStore();

  // React Query hook for fetching inspiration data
  const {
    data: inspiration,
    isLoading,
    isError,
  ...
  useEffect(() => {
    ...
    return () => {
      clearCurrentInspiration();
    };
  }, [inspiration, setCurrentInspiration, clearCurrentInspiration]);
            ...
            <div className="text-center max-w-lg mx-auto">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 sm:p-12">
                <h2 className="text-2xl font-bold text-black dark:text-white mb-4">
                  {isNotFound ? 'Collection Not Found' : 'Error Loading Collection'}
                </h2>
  ...
  // No data state (shouldn't happen if query is successful, but defensive)
      ...
      <div className="min-h-screen bg-white dark:bg-[#0f1419]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="min-h-screen flex items-center justify-center py-12">
            <div className="text-center max-w-lg mx-auto">
              <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-8 sm:p-12">
                <h2 className="text-2xl font-bold text-black dark:text-white mb-4">Collection Not Available</h2>
                <p className="text-gray-600 dark:text-gray-300 mb-8">
  ...
  // Success state - render the collection
  return (
    <div className="min-h-screen bg-white dark:bg-[#0f1419]">
