    ...
    >
      <div className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3 flex-1 min-w-0">
          <button
            onClick={onToggle}
            className={`${isMobile ? "w-5 h-5" : "w-4 h-4"} rounded ${isMobile ? "border-2" : "border-2 rounded-sm"} flex items-center justify-center transition-all duration-200 shrink-0 mt-0.5 ${
              hasProtection
