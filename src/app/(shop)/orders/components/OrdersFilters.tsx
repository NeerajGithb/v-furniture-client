...
import { OrdersFiltersProps } from "@/types/orders";
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  />
                  <span
                    className={`text-sm ${filterStatus === status.value ? "font-semibold " + status.color : "text-gray-600 dark:text-gray-400"} group-hover:text-gray-900 dark:group-hover:text-white transition-colors`}
                  >
                    {status.label}
                  </span>
                </label>
            ...
            <div className="space-y-2.5">
              {[
                ...
                >
                  ...
                  />
                  <span
                    className={`text-sm ${filterTime === time.value ? "font-semibold text-gray-900 dark:text-white" : "text-gray-600 dark:text-gray-400"} group-hover:text-gray-900 dark:group-hover:text-white transition-colors`}
                  >
                    {time.label}
                  </span>
                </label>
