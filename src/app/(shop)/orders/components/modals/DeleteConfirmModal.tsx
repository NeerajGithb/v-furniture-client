            ...
            >
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <div className="min-w-0 flex-1">
                        <h3 className="text-base font-semibold text-gray-900 dark:text-white truncate">Delete Order</h3>
                        <p className="text-gray-600 dark:text-gray-400 text-xs">This action cannot be undone</p>
                    </div>
                </div>

                <div className="mb-4">
                    <p className="text-gray-700 dark:text-gray-300 mb-2 text-sm">Are you sure you want to delete this order?</p>
                    <div className="bg-gray-50 dark:bg-gray-900/50 rounded-xs p-2">
                        <div className="text-sm font-medium text-gray-900 dark:text-white truncate">Order #{orderNumber}</div>
                        <div className="text-xs text-gray-600 dark:text-gray-400">Amount: ₹{totalAmount.toLocaleString()}</div>
                    </div>
                    <p className="text-red-600 dark:text-red-400 text-xs mt-2">⚠️ This will permanently remove the order.</p>
                </div>
