...
export const CancelOrderModal = ({ isOpen, onClose, order }: CancelOrderModalProps) => {
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-gray-700">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Cancel Order</h2>
                    ...
                    <div className="overflow-y-auto max-h-[calc(90vh-80px)]">
                                ...
                                <div>
                                    ...
                                    <div className="space-y-2 max-h-56 overflow-y-auto pr-1">
                                        {cancelReasons.map((reason) => (
                                            <label
                                                key={reason.id}
                                                className={`flex items-center gap-3 p-3 rounded-sm border cursor-pointer transition-all ${selectedReason === reason.id
                                            ...
                                            >
                                                <div className="relative">
                                                    ...
                                                    />
                                                    <div
                                                        className={`w-4 h-4 rounded-full border-2 flex items-center justify-center transition-colors ${selectedReason === reason.id
                        ...
                        {step === 'confirm' && (
                            <div className="p-5 space-y-5">
                                ...
                                <div className="bg-gray-50 dark:bg-gray-900/50 p-4 rounded-sm">
                                    <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">Cancellation reason:</div>
                                ...
                                <div className="bg-green-50 dark:bg-green-900/30 p-4 rounded-sm">
                                    <h4 className="text-sm font-medium text-green-800 dark:text-green-400 mb-2">Refund Information</h4>
