    ...
    return (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center shadow-sm dark:shadow-gray-900">
                ...
                <div className="text-xl font-bold text-gray-900 dark:text-white">{order.items?.length || 0}</div>
                <div className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">Items</div>
            </div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center shadow-sm dark:shadow-gray-900">
                ...
                <div className="text-xl font-bold text-gray-900 dark:text-white">₹{order.totalAmount?.toLocaleString()}</div>
            ...
            <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-3 text-center shadow-sm dark:shadow-gray-900">
                <div className="flex items-center justify-center mb-1.5">
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        isOrderCompleted ? 'bg-green-100 dark:bg-green-900/50' : isOrderActive ? 'bg-gray-100 dark:bg-gray-700' : 'bg-gray-100 dark:bg-gray-700'
                    }`}>
                        {isOrderCompleted ? (
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400 mt-0.5">
                    {isOrderCompleted ? 'Completed' : isOrderActive ? 'Expected' : 'Status'}
                </div>
            </div>

            {/* Order Status */}
            <div className={`border rounded-lg p-3 text-center shadow-sm dark:shadow-gray-900 ${orderStatusDisplay.color}`}>
                <div className="flex items-center justify-center mb-1.5">
