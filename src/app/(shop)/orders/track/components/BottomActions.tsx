...
export function BottomActions({
                ...
                <div className="p-6">
                    <div className="text-center mb-6">
                        ...
                        <p className="text-green-700 dark:text-green-300 max-w-2xl mx-auto">
                            We hope you love your new furniture! Share your experience with others and discover
    ...
    return (
        <div className="mt-8 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 shadow-sm">
            <div className="p-6">
                <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">What's Next?</h3>
                    <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Your order is being processed. Here's what happens next and what you can do while you
                        wait.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    <div className="text-center">
                        <div
                            className={`w-10 h-10 mx-auto mb-2 ${statusSteps[0]?.completed ? 'bg-green-600 dark:bg-green-700' : 'bg-black dark:bg-gray-700'
                                } flex items-center justify-center shadow-sm`}
                        >
                            <CheckCircle className="w-5 h-5 text-white" />
                        </div>
                        <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Order Confirmed</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Your order has been received and confirmed</p>
                    </div>

                    <div className="text-center">
                        <div
                            className={`w-10 h-10 mx-auto mb-2 ${statusSteps[2]?.completed
                        ...
                        <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Items Prepared</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">We're carefully packaging your items</p>
                    </div>

                    <div className="text-center">
                        <div
                            className={`w-10 h-10 mx-auto mb-2 ${statusSteps[3]?.completed
                                ? 'bg-green-600 dark:bg-green-700'
                        ...
                        <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Out for Delivery</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Your package is on its way to you</p>
                    </div>

                    <div className="text-center">
                        <div
                            className={`w-10 h-10 mx-auto mb-2 ${statusSteps[4]?.completed ? 'bg-green-600 dark:bg-green-700' : 'bg-gray-300 dark:bg-gray-600'
                                } flex items-center justify-center shadow-sm`}
                        >
                            <Home className="w-5 h-5 text-white" />
                        </div>
                        <h4 className="font-semibold text-gray-900 dark:text-white mb-1">Delivered</h4>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Package delivered safely to your address</p>
                    </div>
                </div>
