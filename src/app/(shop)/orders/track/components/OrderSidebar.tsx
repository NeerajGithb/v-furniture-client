    ...
    return (
        <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                                ...
                                <div className="mt-1">
                                    ...
                                    <span className="font-semibold">{order.shippingAddress.postalCode}</span>
                                </div>
                            </div>
            ...
            {isOrderActive && expectedDeliveryDisplay && (
                <div className={`border rounded-lg shadow-sm dark:shadow-gray-900 ${
                    ...
                    <div className={`px-4 py-3 border-b rounded-t-lg ${
                        ...
                        <h4 className={`text-sm font-bold flex items-center gap-2 ${
                            ...
                            {expectedDeliveryDisplay.isOverdue ? 'Delivery Delayed' : 'Expected Delivery'}
                        </h4>
                    </div>
