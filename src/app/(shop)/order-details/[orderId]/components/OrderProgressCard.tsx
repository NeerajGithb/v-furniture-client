...
import { OrderProgressCardProps } from "@/types/orderDetails";
  ...
  if (loading) {
    return (
      <Card
        ...
        icon={<Truck size={18} className="text-gray-900 dark:text-white" />}
      >
        <div className="space-y-4 animate-pulse">
          {[1, 2, 3, 4].map((i) => (
            <div key={i} className="flex items-center gap-4 p-3 rounded-xs">
      ...
      >
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            We're thrilled that your order has reached you safely. Thank you for
            choosing us for your shopping needs. We hope you absolutely love
            your purchase!
          </p>
          <div className="mt-4 p-4 bg-green-50 dark:bg-green-900/30 rounded-xs">
            <p className="text-green-700 dark:text-green-400 text-sm font-medium">
              ...
              concerns, our customer support team is here to help.
            </p>
          </div>
        </div>
      </Card>
      ...
      >
        <div className="text-center py-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
            Your order cancellation has been processed successfully. If you made
            an online payment, your refund will be automatically processed to
          ...
          <div className="bg-yellow-50 dark:bg-yellow-900/30 border border-yellow-200 dark:border-yellow-800 rounded-xs p-4">
            <p className="text-yellow-800 dark:text-yellow-400 text-sm">
              Need help with something? Our customer support team is available
              24/7 to assist you with any questions or to help you place a new
              order.
            </p>
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="space-y-4">
        {STATUS_ORDER.filter(
          (_, idx) => idx <= Math.max(currentStatusIndex + 1, 4),
        ).map((statusItem, idx) => {
