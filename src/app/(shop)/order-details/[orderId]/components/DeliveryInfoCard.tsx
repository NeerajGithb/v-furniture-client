...
import { DeliveryInfoCardProps } from "@/types/orderDetails";
...
export function DeliveryInfoCard({
  ...
  if (loading) {
    return (
      <div className="rounded-xs p-4 border-2 bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700">
