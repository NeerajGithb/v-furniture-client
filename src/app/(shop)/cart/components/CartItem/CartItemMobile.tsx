        ...
        <div className="block sm:hidden">
            <div className="relative mb-4">
                ...
                <button
                    ...
                    disabled={isUpdating}
                    className={`absolute top-3 right-3 w-6 h-6 rounded border-2 flex items-center justify-center transition-all duration-200 disabled:opacity-50 ${isSelected
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center flex-wrap gap-2">
                    {item.product?.originalPrice && item.product.originalPrice > item.product.finalPrice && (
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs text-gray-400 dark:text-gray-500">(MRP)</span>
                        </div>
                    )}
                ...
                <div
                    className={`border rounded-xs p-3 transition-all duration-200 ${hasProtection ? 'border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-900/20' : 'border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700'
                        }`}
                >
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                        <div className="font-bold text-lg text-gray-900 dark:text-gray-100">
                            ₹{(item.itemTotal + (hasProtection ? insuranceCost : 0)).toLocaleString()}
                        </div>
                        {hasProtection && (
                            <div className="text-xs text-blue-600 dark:text-blue-400">(incl. ₹{insuranceCost} protection)</div>
                        )}
                    </div>
                </div>
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100 dark:border-gray-800">
                    ...
                    >
                        ...
                        <span className="truncate">{isInWishlist ? 'Saved' : 'Save for Later'}</span>
                    </button>
