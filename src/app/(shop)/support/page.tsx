        ...
        return (
            <div className="min-h-screen bg-gray-50 dark:bg-[#0f1419] flex items-center justify-center p-4">
                <div className="max-w-md w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm p-6 text-center">
                    ...
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Sign In Required</h2>
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-[#0f1419] py-6 sm:py-8">
            <div className="max-w-5xl mx-auto px-4">
                {/* Header */}
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Contact Support</h1>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        {/* Contact Methods */}
                        <div>
                            <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-3">Other Ways to Reach Us</h3>
                            <div className="space-y-3">
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300">vfurnitureshelp@gmail.com</div>
                                    </div>
                                </a>
                                ...
                                >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="text-sm font-medium text-gray-900 dark:text-white group-hover:text-gray-700 dark:group-hover:text-gray-300">+91 123 456 7890</div>
                                        <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Mon-Sat, 9 AM - 6 PM</div>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-1">Response Time</h4>
