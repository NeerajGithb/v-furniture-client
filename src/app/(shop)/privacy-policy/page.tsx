    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0f1419] py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-300">Last updated: January 21, 2026</p>
        </div>

        {/* Introduction */}
        <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6 mb-6">
          <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            At VFurniture, we are committed to protecting your privacy and ensuring the security of your personal information. 
        ...
        <div className="bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5 mb-6">
          ...
          <div className="space-y-2">
            <a href="#information-collection" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">1. Information We Collect</a>
            <a href="#how-we-use" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">2. How We Use Your Information</a>
            <a href="#information-sharing" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">3. Information Sharing and Disclosure</a>
            <a href="#data-security" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">4. Data Security</a>
            <a href="#cookies" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">5. Cookies and Tracking Technologies</a>
            <a href="#your-rights" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">6. Your Privacy Rights</a>
            <a href="#third-party" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">7. Third-Party Services</a>
            <a href="#data-retention" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">8. Data Retention</a>
            <a href="#children" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">9. Children's Privacy</a>
            <a href="#changes" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">10. Changes to This Policy</a>
            <a href="#contact" className="block text-sm text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">11. Contact Us</a>
          </div>
        </div>
        ...
        <div className="space-y-6">
          {/* Section 1 */}
          <section id="information-collection" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
              <div>
                ...
                <p className="leading-relaxed mb-2">When you create an account or place an order, we collect:</p>
              ...
              <div>
                <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Information from Third Parties</h3>
                <p className="leading-relaxed">
                  We may receive information about you from third-party services such as social media platforms 
                  if you choose to connect your account, or from payment processors to verify transactions.
                </p>
              </div>
            </div>
          </section>
          ...
          {/* Section 2 */}
          <section id="how-we-use" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                ...
                <li><strong>Marketing:</strong> To send promotional emails about new products, special offers, and updates (with your consent)</li>
                <li><strong>Personalization:</strong> To customize your shopping experience and show relevant product recommendations</li>
          ...
          {/* Section 3 */}
          <section id="information-sharing" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <Users className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">3. Information Sharing and Disclosure</h2>
            </div>
            ...
            <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <p className="leading-relaxed">
                  ...
                  processing payments, shipping orders, and providing customer service. These providers have 
                  access to your information only to perform specific tasks on our behalf and are obligated 
          ...
          {/* Section 4 */}
          <section id="data-security" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
          ...
          {/* Section 5 */}
          <section id="cookies" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <FileText className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">5. Cookies and Tracking Technologies</h2>
            </div>
            ...
            <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-2 ml-2">
                  <li><strong>Essential Cookies:</strong> Required for website functionality, including authentication and shopping cart</li>
                  <li><strong>Performance Cookies:</strong> Help us understand how visitors interact with our website</li>
                  <li><strong>Functional Cookies:</strong> Remember your preferences and settings</li>
                  <li><strong>Marketing Cookies:</strong> Track your browsing activity to show relevant advertisements</li>
                </ul>
              </div>
          ...
          {/* Section 6 */}
          <section id="your-rights" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <Shield className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">6. Your Privacy Rights</h2>
            </div>
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <p className="leading-relaxed mt-3">
                To exercise these rights, please contact us at vfurnitureshelp@gmail.com. We will respond to 
          ...
          {/* Section 7 */}
          <section id="third-party" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <Users className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">7. Third-Party Services</h2>
            </div>
          ...
          {/* Section 8 */}
          <section id="data-retention" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <Database className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">8. Data Retention</h2>
            </div>
          ...
          {/* Section 9 */}
          <section id="children" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
          ...
          {/* Section 10 */}
          <section id="changes" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <FileText className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              <p className="leading-relaxed">
                ...
                on our website and updating the "Last updated" date at the top of this page.
              </p>
              <p className="leading-relaxed">
                We encourage you to review this Privacy Policy periodically to stay informed about how we 
                protect your information. Your continued use of our website after any changes indicates your 
          ...
          {/* Section 11 */}
          <section id="contact" className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <div className="flex items-start gap-3 mb-4">
              <Mail className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">11. Contact Us</h2>
            </div>
            ...
            <div className="space-y-3 text-sm text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-2">
                <p><strong>Email:</strong> vfurnitureshelp@gmail.com</p>
        ...
        <div className="mt-8 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-5">
          <div className="flex items-start gap-3">
            <Shield className="w-5 h-5 text-gray-700 dark:text-gray-300 mt-0.5" />
            <div>
              <h3 className="text-sm font-bold text-gray-900 dark:text-white mb-2">Your Privacy is Our Priority</h3>
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
                At VFurniture, we are committed to transparency and protecting your personal information. 
                If you have any questions or concerns about how we handle your data, please don't hesitate 
