...
export const AvailabilitySection = ({ isExpanded, onToggle, inStock, onSale, onCheckboxChange }: Props) => (
    <FilterSection title="Availability" isExpanded={isExpanded} onToggle={onToggle}>
