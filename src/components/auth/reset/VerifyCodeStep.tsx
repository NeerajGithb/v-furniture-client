    ...
    return (
        ...
        >
            ...
            <button
                ...
                disabled={loading}
                onClick={onResend}
                className="text-xs text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white transition-colors mx-auto block disabled:opacity-50 disabled:cursor-not-allowed"
            >
