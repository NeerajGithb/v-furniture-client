    ...
    >
      ...
      >
        <div className="flex flex-wrap gap-x-3 gap-y-1 text-xs">
          <span
            className={`flex items-center gap-1 transition-colors ${hasMinLength ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
          >
          ...
          <span
            className={`flex items-center gap-1 transition-colors ${hasUppercase ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
          >
          ...
          <span
            className={`flex items-center gap-1 transition-colors ${hasNumber ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
          >
          ...
          <span
            className={`flex items-center gap-1 transition-colors ${hasSpecial ? "text-green-600 dark:text-green-400" : "text-gray-500 dark:text-gray-400"}`}
          >
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            ...
            transition={{ duration: 0.2, ease: smoothEasing }}
            className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded p-3 space-y-2"
          >
            <div className="flex items-start gap-2">
              <div className="w-3 h-3 text-red-500 dark:text-red-400 mt-0.5 flex-shrink-0">
