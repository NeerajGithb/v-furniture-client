...
const SkeletonCard = memo(() => (
  <div
    className="bg-white border border-gray-200 overflow-hidden shadow-sm w-full mx-auto p-1.5"
    style={{
      aspectRatio: '3/4',
      minWidth: '200px',
      maxWidth: '370px',
  ...
  >
    {/* Image shimmer */}
    <div
      className="bg-linear-to-r from-gray-200 via-gray-100 to-gray-200 relative overflow-hidden"
      style={{ height: '65%' }}
    >
      <div className="absolute inset-0 bg-linear-to-r from-transparent via-white to-transparent animate-shimmer transform -skew-x-12"></div>
    </div>
