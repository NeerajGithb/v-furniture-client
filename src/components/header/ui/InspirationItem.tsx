...
const InspirationItem = ({ inspiration, isActive, onEnter, onGetPosition, onLeave }: InspirationItemProps) => {
    ...
    return (
        ...
        >
            ...
            {isActive && (
                <div
                    className="absolute bottom-0 left-3 right-3 h-px [background-color:var(--brand-strong)]"
                />
            )}
        </li>
    );
